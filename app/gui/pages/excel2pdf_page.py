"""
Funcionalidad: Excel a PDF
Falta mejoras y desarrollo del codigo para un mejor funcionamiento
"""
...
class Excel2PdfPage(BasePage):
    def create_widgets(self):
        self.selected_file = None
        
        # Encabezado
        header = ctk.CTkLabel(self.content_frame, text="Excel a PDF", font=(Theme.FONT_FAMILY, 24, "bold"), text_color=Theme.TEXT_MAIN)
        header.pack(pady=20)
        ...
        ctk.CTkButton(select_frame, text="Seleccionar archivo Excel", command=self.select_file,
    ...
    def convert_file(self):
        ...
        if output_path:
            try:
                Converter.excel_to_pdf(self.selected_file, output_path)
