"""
PDF a Word
Implementado pero falta desarrollo
Codigo simple
"""
...
class Pdf2WordPage(BasePage):
    def create_widgets(self):
        self.selected_file = None
        
        # Encabezado
        header = ctk.CTkLabel(self.content_frame, text="PDF a Word", font=(Theme.FONT_FAMILY, 24, "bold"), text_color=Theme.TEXT_MAIN)
        header.pack(pady=20)
        ...
        # Botón de Conversión
        ctk.CTkButton(self.content_frame, text="Convertir a Word", command=self.convert_file, 
    ...
    def convert_file(self):
        ...
        if output_path:
            try:
                Converter.pdf_to_word(self.selected_file, output_path)
                messagebox.showinfo("Éxito", "¡Documento Word creado con éxito!")
                self.selected_file = None
