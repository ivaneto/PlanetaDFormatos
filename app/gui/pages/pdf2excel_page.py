"""
PDF a Excel
Funcionalidad en desarrollo, no implementada porque requiere mas desarrollo en el codigo.
Codigo simple
"""
...
class Pdf2ExcelPage(BasePage):
    def create_widgets(self):
        self.selected_file = None
        
        # Encabezado
        header = ctk.CTkLabel(self.content_frame, text="PDF a Excel", font=(Theme.FONT_FAMILY, 24, "bold"), text_color=Theme.TEXT_MAIN)
        header.pack(pady=20)
        ...
        # Botón de Conversión
        ctk.CTkButton(self.content_frame, text="Convertir a Excel", command=self.convert_file, 
    ...
    def convert_file(self):
        ...
        if output_path:
            try:
                Converter.pdf_to_excel(self.selected_file, output_path)
                messagebox.showinfo("Éxito", "¡Archivo Excel creado con éxito!")
                self.selected_file = None
